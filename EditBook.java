...
public class EditBook extends javax.swing.JFrame {
    ...
    static String uID;
    static int wallet;
    public EditBook(String userID, int w) {
        initComponents();
        uID=userID;
        wallet=w;
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 220, 184, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 330, 130, 40));
...
//                    JOptionPane.showMessageDialog(null, "You can edit now");
                    setVisible(false);
                    new Publish(uID,bookID,wallet).setVisible(true);
            }
            else{
