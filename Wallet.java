...
public class Wallet extends javax.swing.JFrame {
    ...
    static String uID;
    static int wallet;
    public Wallet(String userID,int w) {
        initComponents();
        uID=userID;
        wallet=w;
        jTextField1.setText(Integer.toString(wallet));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(408, 197, -1, -1));

        jTextField1.setFont(new java.awt.Font("Optima", 1, 24)); // NOI18N
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(793, 194, 167, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(488, 299, -1, -1));
        getContentPane().add(jSpinField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(793, 299, 167, 36));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(662, 389, 130, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into wallet values ('"+uID+"','"+amount+"','"+add+"')");
                JOptionPane.showMessageDialog(null, "Successfully requested admin to money");
            }
